...
class Weapon(object):
  def __init__(self, name, attack, uses, vsperson, vszombie, vsvampire, vsghoul, vswerewolf):
    self.name = name
    self.attack = attack
    self.uses = uses
    self.vsperson = vsperson
    self.vszombie = vszombie
    self.vsvampire = vsvampire
    self.vsghoul = vsghoul
    self.vswerewolf = vswerewolf
